...
from .adaptive import adaptive_quadrature
from .quad_weights import ccmod_weights
from .utils import wrap_func
from .fixed_order import fixed_quadcc, _dot


class AlgLogWeight(eqx.Module):
